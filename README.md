Порт QCheckers 0.9.0 для ОС Аврора
======================
:-------------------------:|:-------------------------:|:-------------------------:|:-------------------------:
![Изображение 1](images/1.png)  |  ![Изображение 2](images/2.png) |  ![Изображение 3](images/3.png) |  ![Изображение 4](images/4.png)

Особенности по сравнению с оригинальной версией

* Интерфейс переписан на qml (Аврора не поддерживает Qt Widgets)
* Только русские шашки
* Нет режима свободной расстановки, пауз и отмены ходов
* Поддерживаются только svg-темы
* Добавлена возможность поделиться PDN-файлом через штатный механизм ОС

### Зеркало порта на [GitFlic](https://gitflic.ru/project/sash0k/qcheckers-aurora)
